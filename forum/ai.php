...
<?php
      ...
      {
          $image=$row['image'];
    	  echo '<li class="profile_img"><a href="../connection/user_logout.php"><img src="'.$image.'" alt="No image found" width="3vw" height="5vh"></a></li>';
      }
      ?>
      </ul>
  </nav>
  ...
  <div class="left_nav">
    ...
    <div class="fil_cat">
      ...
      <div class="filter_parameter1" id="page_active"><i class="fa-sharp fa-regular fa-circle"></i><a href="ai.php">AI</a></div>
  ...
  <div class="main_content">
    <div class="main_head">Welcome to CS Community</div>
      ...
      <?php
       ...
       $sql1="SELECT * FROM threads WHERE thread_topic='AI'";
