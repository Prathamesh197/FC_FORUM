...
<?php
  ...
  <div class="left_nav">
    ...
    <div class="other">
      ...
      <div class="filter_parameter1"  id="page_active"><i class="fa-regular fa-comment"></i><a href="most_replies.php">Most Replies</a></div>
    </div>
  ...
  <div class="main_content">
    <div class="main_head">Welcome to CS Community</div>
      ...
      include '../connection/db_connect.php';
       ...
       $sql1="SELECT * FROM threads ORDER BY thread_id ASC";
       ...
       while($row1=pg_fetch_assoc($exec1))
       {
          ...
          $sql_count="SELECT COUNT(reply_id) FROM replies WHERE thread_reply_id=$thread_id ORDER BY COUNT DESC";
