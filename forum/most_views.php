...
<?php
  ...
  <div class="left_nav">
    ...
    <div class="other">
      ...
      <div class="filter_parameter1"  id="page_active"><i class="fa-solid fa-eye"></i><a href="most_views.php">Most Views</a></div>  
  ...
  <div class="main_content">
    <div class="main_head">Welcome to CS Community</div>
      ...
      <?php
       ...
       $sql1="SELECT * FROM threads ORDER BY thread_views DESC";
