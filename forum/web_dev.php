...
<?php
  ...
  <div class="left_nav">
    ...
    <div class="fil_cat">
      ...
      <div class="filter_parameter1"  id="page_active"><i class="fa-regular fa-circle"></i><a href="web_dev.php">Web Dev</a></div>
  ...
  <div class="main_content">
    <div class="main_head">Welcome to CS Community</div>
      ...
      <?php
       ...
       $sql1="SELECT * FROM threads WHERE thread_topic='Web Dev'";
