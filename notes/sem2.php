...
<?php
  ...
  <div class="main_content">
    <div class="main_head">Semester 2</div>
    ...
    <div class="table_data1">
        <div class="subject">Statistics I</div>
        <div class="subject_code">CSC1201</div>
        <div class="download"><a href="">Download</a></div>
    </div>

    <div class="table_data2">
        <div class="subject">Statistics I</div>
        <div class="subject_code">CSC1202</div>
        <div class="download"><a href="">Download</a></div>
    </div>
    <div class="table_data3">
        <div class="subject">C++</div>
        <div class="subject_code">CSC1203</div>
        <div class="download"><a href="">Download</a></div>
    </div>
    <div class="table_data4">
        <div class="subject">IOT</div>
        <div class="subject_code">CSC1204</div>
        <div class="download"><a href="">Download</a></div>
    </div>
    <div class="table_data5">
        <div class="subject">C Language Advanced</div>
        <div class="subject_code">CSC1205</div>
        <div class="download"><a href="">Download</a></div>
    </div>
    </div> 
