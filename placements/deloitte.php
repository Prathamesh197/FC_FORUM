...
<?php
  ...
  <div class="left_nav">
    ...
    <div class="fil_cat">
        ...
        <div class="filter_parameter1"  id="hover"><i class="fa-solid fa-hashtag"></i><a href="deloitte.php">Deloitte</a></div>
  ...
  <div class="main_content">
    <div class="main_head">Secure and grow your career . Stay updated ! </div>
      ...
      <?php
       ...
       $sql1="SELECT * FROM placements WHERE company_name='Deloitte'";
