...
<?php
  ...
  <div class="left_nav">
    ...
    <div class="other_fil_head">
        ...
        <div class="filter_parameter1"><i class="fa-solid fa-hashtag"></i><a href="associate_analyst.php">Associate Analyst</a></div>
        <div class="filter_parameter1"><i class="fa-solid fa-hashtag"  id="hover"></i><a href="systems_associate.php">Systems Associate</a></div>
  ...
  <div class="main_content">
    <div class="main_head">Secure and grow your career . Stay updated ! </div>
      ...
      <?php
       ...
       $sql1="SELECT * FROM placements WHERE job_role='Systems Associate'";
