...
<?php
  ...
  <div class="left_nav">
    ...
    <div class="other_fil_head">
        ...
        <div class="filter_parameter1"  id="hover"><i class="fa-solid fa-hashtag"></i><a href="web_developer.php">Web Developer</a></div>
    </div>
  ...
  <div class="main_content">
    <div class="main_head">Secure and grow your career . Stay updated ! </div>
      ...
      <?php
       ...
       $sql1="SELECT * FROM placements WHERE job_role='Web Developer'";
